...
This folder contains public, anonymized, or synthetic raw inputs.
...
A full public-data version could use:

- local fiscal revenue and expenditure statistics
- land-transfer revenue statistics
- public bond yield or spread indicators
